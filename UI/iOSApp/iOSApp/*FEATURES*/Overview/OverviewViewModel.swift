...
public class OverviewViewModel: ObservableObject {
	...
	let marchData: [ChartData] = [
		...
		ChartData(day: Date.date(2023, 3, 6), spendings: 300),
		ChartData(day: Date.date(2023, 3, 7), spendings: 250),
		ChartData(day: Date.date(2023, 3, 8), spendings: 350),
		ChartData(day: Date.date(2023, 3, 9), spendings: 450),
		ChartData(day: Date.date(2023, 3, 10), spendings: 550),
		ChartData(day: Date.date(2023, 3, 11), spendings: 650),
		ChartData(day: Date.date(2023, 3, 12), spendings: 300),
		ChartData(day: Date.date(2023, 3, 13), spendings: 200),
		ChartData(day: Date.date(2023, 3, 14), spendings: 200),
		ChartData(day: Date.date(2023, 3, 15), spendings: 50),
		ChartData(day: Date.date(2023, 3, 16), spendings: 500),
		ChartData(day: Date.date(2023, 3, 17), spendings: 25),
		ChartData(day: Date.date(2023, 3, 18), spendings: 323),
		ChartData(day: Date.date(2023, 3, 19), spendings: 204),
		ChartData(day: Date.date(2023, 3, 20), spendings: 583),
		ChartData(day: Date.date(2023, 3, 21), spendings: 123),
		ChartData(day: Date.date(2023, 3, 22), spendings: 400),
		ChartData(day: Date.date(2023, 3, 23), spendings: 400),
		ChartData(day: Date.date(2023, 3, 24), spendings: 400),
